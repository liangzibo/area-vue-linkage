<template>
    <div class="code-area">
        ...
        <div class="original-code" ref="original" v-if="shown">
            <pre><code><span>//返回值是一个数组，数组项是包含省市的行政区域代码和文本的对象</span><br /><span>&lt;</span>template<span>&gt;</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;<span>&lt;</span>area-select&nbsp;type='all'&nbsp;v-model='selected' :data='$pcaa' :level='3'&gt;&lt;/area-select&gt;<br/>&lt;</span>/template<span>&gt;</span></code></pre>
        </div>
